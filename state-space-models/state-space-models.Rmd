...
![*The position, speed and acceleration of the rocket*]Image here *** plotting-position-velocity-acceleration.R ***
...
![*The true position (points) versus our noisy measurement (line). Note that the position x does not represent a perfect parabola due to the noise we inserted into the state transition equation*]Image here *** sensor-x.R ***
...
![*Kalman filtering - Position: True, Measured and Estimated*]