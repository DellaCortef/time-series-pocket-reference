...
Os resíduos não mostram mais valores enormes para as respectivas ACF e pACF. Dada nossa vontade de um modelo parcimonioso e os riscos de sobreajustes de um modelo ARIMA, um analista sábio pararia por aqui mesmo, já que não temos nenhum comportamento adicional nos resíduos que precisem ser ajustados por meio de um componente autorregressivo, de média móvel ou diferenciação. Podemos trazer mais complexidade ajustando MA (2) para nosso modelo:
