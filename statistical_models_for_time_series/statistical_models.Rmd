...
*linear regression* that will undoubtedly help to offer clear and simple instructions on the behavior of the **time series**. The data requirements just described are similar to those in *standard linear regression* applied to cross-sectional data.Consequences of using *linear regression* outside the standards:
