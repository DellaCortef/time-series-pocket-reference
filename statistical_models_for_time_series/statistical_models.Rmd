...
ARIMA models continue to perform at par with the latest, especially when dealing with small data sets where the most sophisticated machine learning or deep learning models are not the best. However, even ARIMA models present risks of overfitting, despite their relative simplicity.
