...
Podemos ver que nem a função ACF tampouco a PACF possuem um cutoff acentuado, sugerindo que temos um processo ARMA. Começaremos ajustando um modelo ARIMA (1, 0, 1) relativamente simples, pois não vemos necessidade de diferenciação e nenhuma evidência:
