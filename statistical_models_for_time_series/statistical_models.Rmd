...
##### - Os padrões ACF e PACF diferem dos processos MA e AR
Ao contrário de um processo autorregressivo que tem uma ACF de decaimento exponencial lento, a definição do processo MA garante um cutoff acentuado da ACF para qualquer valor maior que *q*, a ordem do processo MA. Isso ocorre porque um processo autorregressivo depende de termos anteriores, e eles incorporam os impulsos anteriores ao sistema, ao passo que um modelo MA, que incorpora os impulsos diretamente por meio de seu valor, tem um mecanismo para impedir que a propagação dos impulsos progrida indefinidamente.

Podemos observar valores significatos nos lags 3 e 9, então ajustamos um modelo MA com esses lags. É necessário tomar cuidado para não restringir sem querer os coeficientes errados em 0 no modelo, o que podemos confirmar ao exibir:
