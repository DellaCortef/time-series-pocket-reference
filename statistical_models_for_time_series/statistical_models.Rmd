...
data is not actually stationary when we fit it, so that an unidentified trend can be masked as good model performance, when in fact it is just a quirk of the data that should be addressed before modeling.
