...
it shows that the visual selection we made examining PACF is compatible with the selection that would be made minimizing an information criterion. Although there are two different ways of choosing the model order, here they are compatible.
