...
Os resíduos mostram valores PACF enormes, sugerindo que não representamo totalmente o comportamento autorregressivo. por isso, criamos o modelo adicionando um componente AR de ordem superior, testamos um modelo ARIMA (2, 0, 1) no código a seguir e, depois, plotaremos a ACF e PACF dos resíduos desse modelo mais complexo:
