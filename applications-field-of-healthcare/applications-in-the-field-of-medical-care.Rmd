...
![https://github.com/DellaCortef/time-series-pocket-reference/blob/main/applications-field-of-healthcare/images/flu-paris-ts.R.png?raw=true](By plotting the flu rate time series, we can see the seasonality of the flu rate)
